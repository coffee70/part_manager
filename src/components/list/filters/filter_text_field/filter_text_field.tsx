import TextFieldFilterBase from "@/components/list/filters/filter_text_field/filter_text_field_base";
...
export default function TextFieldFilter({ fieldId, placeholder, fieldName }: Props) {
    ...
    return (
        <Filter trigger={
            <FilterButton 
                active={isActive} 
                data-testid={`text-field-filter-trigger-${fieldName}`} 
            />
        }>
            <TextFieldFilterBase fieldId={fieldId} placeholder={placeholder} />
        </Filter>
    )
} 