...
export async function startRoute(input: z.input<typeof InputSchema>) {
    ...
    instance.route.state = RouteState.Started;

    if (instance.route.nodes.length === 0) {
        throw new Error("Instance does not have any nodes");
    }
