...
export async function deleteRouteField(
    ...
    const { modelId, instanceId, sectionId, fieldId } = validation.data;
    ...
    // Delete the field from the section
    await collection.updateOne(
        ...
        {
            $pull: {
                'route_fields.$.fields': { _id: new ObjectId(fieldId) }
            },
            $set: {
                updatedAt: new Date(),
                updatedBy: user._id
